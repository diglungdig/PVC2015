    ...
    public class MenuButton : MonoBehaviour
    {
        ...
        private IEnumerator ActivateButton()
        {
            ...
            if (loadCanvas)
            {
                ...
                if(gameObject.name == "HazardGame")
                {
                    gameObject.GetComponent<MenuItemPopout>().overrideBool = true;
                }

                Camera.main.transform.parent.GetComponent<Animator>().SetBool("GotoCanvas", true);
